...
void MainWindow::setupFigure ()
{
    ...
    whiteFigure[12] = new Figure (Color::WHITE, backfield, backfield[6][4]);
    whiteFigure[13] = new Figure (Color::WHITE, backfield, backfield[6][5]);
    whiteFigure[14] = new Figure (Color::WHITE, backfield, backfield[6][6]);
